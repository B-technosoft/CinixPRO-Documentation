...
import { useGetPatientDetailsForReceptionisQuery } from "../../redux/api/receptionist/receptionist-patient/receptionist-patient";
import { API_URL } from "../../redux/api/api-slice";
import ReceptionistPatientAppointmentsCountComponent from "../ReceptionistPatientAppointmentsCountComponent/ReceptionistPatientAppointmentsCountComponent";
import ReceptionistPatientInformationComponent from "../ReceptionistPatientInformationComponent/ReceptionistPatientInformationComponent";
import BreadcrumbComponent from "../BreadcrumbComponent/BreadcrumbComponent";

const ReceptionistPatientDetailsComponent = () => {
  const { id } = useParams();

  const { data, isFetching, isSuccess } =
    useGetPatientDetailsForReceptionisQuery(id);
      ...
      <div className="flex flex-col gap-7">
        ...
        <div className="flex gap-6 grow">
          ...
          <div className="w-full flex gap-6 flex-col">
            <ReceptionistPatientAppointmentsCountComponent />
            <ReceptionistPatientInformationComponent />
          </div>
        </div>
      </div>
    </LayoutComponent>
...
export default ReceptionistPatientDetailsComponent;
