...
const DoctorPendingAppointmentComponent = () => {
  const { data, isFetching } = useGetPendingAppointmentListForDoctorQuery({});

  const [cancelAppointment] = useCancelAppointmentForDoctorMutation();
  const [confirmAppointment] = useCompleteAppointmentForDoctorMutation();
...
export default DoctorPendingAppointmentComponent;
