...
import { useInvoicesPDFForPatientQuery } from "../../redux/api/patient/patient-invoice/patient-invoice";
...
const PatientViewInvoicesComponent = () => {
  const { file } = useParams();

  const { data, isFetching } = useInvoicesPDFForPatientQuery(`${file}`);
...
export default PatientViewInvoicesComponent;
