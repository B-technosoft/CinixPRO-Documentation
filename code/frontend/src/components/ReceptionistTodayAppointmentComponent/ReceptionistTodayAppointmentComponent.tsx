...
const ReceptionistTodayAppointmentComponent = () => {
  const { data, isFetching } = useGetTodayAppointmentListForReceptionisQuery(
    {}
  );
...
export default ReceptionistTodayAppointmentComponent;
