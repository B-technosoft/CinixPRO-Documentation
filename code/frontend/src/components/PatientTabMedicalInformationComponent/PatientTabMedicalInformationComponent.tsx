...
const PatientTabMedicalInformationComponent = () => {
  const { id } = useParams();

  const { data, isFetching, isSuccess } = useGetPatientDetailsForSuperAdminQuery(id);
...
export default PatientTabMedicalInformationComponent;
