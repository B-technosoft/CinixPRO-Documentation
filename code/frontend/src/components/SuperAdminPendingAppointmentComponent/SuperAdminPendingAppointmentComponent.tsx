...
const SuperAdminPendingAppointmentComponent = () => {
  const { data, isFetching } = useGetPendingAppointmentListForSuperAdminQuery(
    {}
  );
...
export default SuperAdminPendingAppointmentComponent;
