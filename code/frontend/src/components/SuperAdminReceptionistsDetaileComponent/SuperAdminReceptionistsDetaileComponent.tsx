...
import { useGetReceptionistByIdForSuperAdminQuery } from "../../redux/api/super-admin/super-admin-reception/super-admin-reception";
import { API_URL } from "../../redux/api/api-slice";
import ReceptionistsAppointmentsCountComponent from "../ReceptionistsAppointmentsCountComponent/ReceptionistsAppointmentsCountComponent";
import ReceptionistsInformationComponent from "../ReceptionistsInformationComponent/ReceptionistsInformationComponent";
import BreadcrumbComponent from "../BreadcrumbComponent/BreadcrumbComponent";

const SuperAdminReceptionistsDetaileComponent = () => {
  const { id } = useParams();
      ...
      <div className="flex flex-col gap-7">
        ...
        <div className="flex gap-6 grow">
                    ...
                    <div className="absolute bottom-20">
                      <div className="avatar">
                        <div className="w-14 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                          ...
                          {data && isSuccess && (
                            <LazyLoadImage
                              src={`${API_URL}/api/media/receptionist/${data.profilePhoto}`}
          ...
          <div className="w-full flex gap-6 flex-col">
            <ReceptionistsAppointmentsCountComponent />
            <ReceptionistsInformationComponent />
          </div>
        </div>
      </div>
    </LayoutComponent>
...
export default SuperAdminReceptionistsDetaileComponent;
