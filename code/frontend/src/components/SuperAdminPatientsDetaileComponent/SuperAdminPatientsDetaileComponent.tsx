...
import { useGetPatientDetailsForSuperAdminQuery } from "../../redux/api/super-admin/super-admin-patient/super-admin-patient";
import { API_URL } from "../../redux/api/api-slice";
import PatientAppointmentsCountComponent from "../PatientAppointmentsCountComponent/PatientAppointmentsCountComponent";
...
const SuperAdminPatientsDetaileComponent = () => {
  const { id } = useParams();
      ...
      <div className="flex flex-col gap-7">
        ...
        <div className="flex gap-6 grow">
          ...
          <div className="w-full flex gap-6 flex-col">
            <PatientAppointmentsCountComponent />
...
export default SuperAdminPatientsDetaileComponent;
